...
export const EXTENSION_TO_ENDPOINT: Record<string, Record<string, string>> = {
  ...
  cbz: { pdf: "cbz-to-pdf" },
  docx: { pdf: "file-to-pdf" },
  doc: { pdf: "file-to-pdf" },
  odt: { pdf: "file-to-pdf" },
  xlsx: { pdf: "file-to-pdf" },
  xls: { pdf: "file-to-pdf" },
  ods: { pdf: "file-to-pdf" },
  pptx: { pdf: "file-to-pdf" },
  ppt: { pdf: "file-to-pdf" },
  odp: { pdf: "file-to-pdf" },
  jpg: { pdf: "img-to-pdf" },
  jpeg: { pdf: "img-to-pdf" },
  ...
  epub: { pdf: "ebook-to-pdf" },
  mobi: { pdf: "ebook-to-pdf" },
  azw3: { pdf: "ebook-to-pdf" },
  fb2: { pdf: "ebook-to-pdf" },
};
